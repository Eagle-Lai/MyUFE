...
using NetworkConnectionError = NetworkConnectionErrorCompat;
using NetworkDisconnection = NetworkDisconnectionCompat;
using NetworkMessageInfo = NetworkMessageInfoCompat;
using NetworkPeerType = NetworkPeerTypeCompat;
using NetworkPlayer = NetworkPlayerCompat;
using NetworkView = NetworkViewCompat;
using RPC = RPCCompat;
using RPCMode = RPCModeCompat;
